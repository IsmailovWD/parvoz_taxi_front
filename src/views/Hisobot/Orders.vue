        ...
        <n-tab-pane name="Tugallanganlar" tab="Tugallanganlar">
          <n-space vertical :size="12">
            ...
            <div style="float: right;">
              <n-pagination :disabled="spin" v-model:page="pagination.page" :page-count="pagination.pageCount"
                @update:page="handlePageChange">
                <template #prefix>
                  <div style="font-size: 16px;">
                    Jami: <span style="font-weight: bold; color: #18a058;"> {{ pagination.soni }} </span> ta buyurtmadan
                    <span style="font-weight: bold; color: #d03050;"> {{ data.length }} </span> tasi
                  </div>
                </template>
              </n-pagination>
            </div>
